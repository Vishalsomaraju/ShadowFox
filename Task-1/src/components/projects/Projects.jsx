...
export default function Projects() {
  return (
    <section id="projects" className="min-h-screen text-white">
      <div className="bg-gradient-to-tl from-[#1e293b] via-[#334155] to-[#475569] bg-opacity-90 shadow-inner border-t border-slate-600 mx-0 md:mx-20 rounded-lg p-10 md:p-24">
        <h1 className="inline-block text-2xl md:text-4xl text-cyan-400 font-bold transition-transform duration-300 transform hover:scale-105 origin-center mb-12">
          Projects
        </h1>
